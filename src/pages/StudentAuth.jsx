...
function SignupWizard() {
  ...
  const [form, setForm] = useState({ name: "", photoUrl: "", dob: "", gender: "", mobile: "", aadhar: "", aadharPhotoUrl: "", password: "", hallSlug: "" });
  ...
  return (
    <div>
      ...
      <Field label="Your photo"><PhotoUpload label="Take / upload photo" value={form.photoUrl} onChange={(url) => setForm((f) => ({ ...f, photoUrl: url }))} capture /></Field>
      ...
      <Field label="Aadhar card photo"><PhotoUpload label="Upload Aadhar card" value={form.aadharPhotoUrl} onChange={(url) => setForm((f) => ({ ...f, aadharPhotoUrl: url }))} /></Field>
