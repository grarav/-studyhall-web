    ...
    <div style={{ minHeight: "100vh" }}>
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 14, marginBottom: 4 }}>Valid until: {me.expiry_date ? new Date(me.expiry_date).toLocaleDateString() : "—"}</div>
          {expiry && (
          ...
          <>
            {!renewOpen && !changeOpen && (
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <button
                  onClick={async () => { const res = await api.vacantSeats(me.hall_slug).catch(() => ({ seats: [] })); setVacantSeats(res.seats || []); setChangeOpen(true); }}
